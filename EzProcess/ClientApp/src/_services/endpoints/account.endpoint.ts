...
export class AccountEndpoint extends EndpointBase {
  ...
  getNewUserEndpoint<T>(userObject: any): Observable<T> {
    ...
    return this.http.post<T>(this.usersUrl, JSON.stringify(userObject)).pipe<T>(
      catchError(error => {
  ...
  getUpdateUserEndpoint<T>(userObject: any, userId?: string): Observable<T> {
    ...
    return this.http.put<T>(endpointUrl, JSON.stringify(userObject)).pipe<T>(
      catchError(error => {
  ...
  getPatchUpdateUserEndpoint<T>(valueOrPatch: any, opOrUserId?: string, path?: string, from?: any, userId?: string): Observable<T> {
    ...
    return this.http.patch<T>(endpointUrl, JSON.stringify(patchDocument)).pipe<T>(
      catchError(error => {
  ...
  getUserPreferencesEndpoint<T>(): Observable<T> {
    ...
    return this.http.get<T>(this.currentUserPreferencesUrl).pipe<T>(
      catchError(error => {
  ...
  getUpdateUserPreferencesEndpoint<T>(configuration: string): Observable<T> {
    return this.http.put<T>(this.currentUserPreferencesUrl, JSON.stringify(configuration)).pipe<T>(
      catchError(error => {
  ...
  getUnblockUserEndpoint<T>(userId: string): Observable<T> {
    ...
    return this.http.put<T>(endpointUrl, null).pipe<T>(
      catchError(error => {
  ...
  getDeleteUserEndpoint<T>(userId: string): Observable<T> {
    ...
    return this.http.delete<T>(endpointUrl).pipe<T>(
      catchError(error => {
  ...
  getNewRoleEndpoint<T>(roleObject: any): Observable<T> {
    ...
    return this.http.post<T>(this.rolesUrl, JSON.stringify(roleObject)).pipe<T>(
      catchError(error => {
  ...
  getUpdateRoleEndpoint<T>(roleObject: any, roleId: string): Observable<T> {
    ...
    return this.http.put<T>(endpointUrl, JSON.stringify(roleObject)).pipe<T>(
      catchError(error => {
  ...
  getPermissionsEndpoint<T>(): Observable<T> {
    ...
    return this.http.get<T>(this.permissionsUrl).pipe<T>(
      catchError(error => {
